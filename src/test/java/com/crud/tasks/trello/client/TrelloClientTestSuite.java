...
public class TrelloClientTestSuite {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloClient()).thenReturn("/michaboczula");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        trelloBoardDto[0] = new TrelloBoardDto("test_id", "test_board", new ArrayList<>());

        URI uri = new URI("http://test.com/members/michaboczula/boards?key=test&token=test&fields=name,id&lists=all");
