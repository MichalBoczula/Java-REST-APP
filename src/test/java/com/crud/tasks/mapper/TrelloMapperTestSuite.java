...
public class TrelloMapperTestSuite {
    ...
    public void mapToCard() {
        ...
        final TrelloCardDto secondTestCard = new TrelloCardDto("second", "testCard", "2", "2");
        //when
        ...
        assertEquals(secondTestCard.getName(), secondTest.getName());
        assertEquals(secondTestCard.getDescription(), secondTest.getDescription());
        assertEquals(secondTestCard.getPos(), secondTest.getPos());
        assertEquals(secondTestCard.getListId(), secondTest.getListId());
    }
    ...
    public void mapToCardDto() {
        ...
        final TrelloCard secondTestCard = new TrelloCard("second", "testCard", "2", "2");
        //when
